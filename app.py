...
try:
    ...
    st.error(f"❌ Error: {e}")
    st.info("Make sure 'fda_random_forest_model.pkl' and 'fda_scaler.pkl' are in the same folder as app.py")
...
if st.button("🔮 Run Prediction"):
    if model is None or scaler is None:
        st.error("Model assets could not be loaded. Prediction is unavailable.")
    else:
        # Encoding
