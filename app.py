...
# Initialize assets as None to avoid NameError if loading fails
...
if st.button("Run Prediction"):
    if model is None or scaler is None:
        st.error("Cannot run prediction because the model or scaler failed to load.")
    else:
        # Encoding
        ...
        try:
            ...
            st.info("Ensure the feature order matches exactly how the model was trained in Colab.")
